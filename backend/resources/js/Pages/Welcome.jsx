            ...
            <div className="relative min-h-screen bg-[#FFF9F5] text-gray-900 font-sans selection:bg-orange-500 selection:text-white">
                ...
                <div className="relative min-h-screen flex flex-col justify-between overflow-hidden">
                    ...
                    <div className="absolute top-0 right-0 w-full lg:w-[55%] h-full z-0">
                        <div className="absolute inset-0 bg-gradient-to-r from-[#FFF9F5] via-[#FFF9F5]/75 to-transparent z-10 hidden lg:block" />
                        <div className="absolute inset-0 bg-gradient-to-t from-[#FFF9F5] via-transparent to-transparent z-10 lg:hidden" />
                    ...
                    <div className="relative z-20 w-full flex flex-col flex-1">
                            ...
                            <div className="flex items-center gap-4 ml-auto flex-shrink-0">
                                ...
                                {auth?.user ? (
                                    <Link
                                        ...
                                        className="font-semibold text-orange-500 border border-orange-500 px-6 py-2.5 rounded-xl hover:bg-orange-50 transition shadow-sm"
                                    >
                                        Painel
                                    </Link>
                                ) : (
                                    <>
                                        <Link
                                            href={route('login')}
                                            className="font-semibold text-gray-700 hover:text-orange-600 px-4 py-2.5 transition"
                                        >
                                            Login
                                        </Link>
                                        {canRegister && (
                                            <Link
                                                href={route('register')}
                                                className="bg-[#F26522] hover:bg-[#d95a1e] hover:shadow-lg hover:shadow-orange-500/20 transition duration-300 text-white px-6 py-2.5 rounded-xl font-semibold whitespace-nowrap"
                                            >
                                                Crie conta
                                            </Link>
                                        )}
                        ...
                        <main className="flex-1 max-w-7xl w-full mx-auto px-6 md:px-12 pt-12 md:pt-20 pb-40 flex flex-col justify-center">
                            <div className="max-w-2xl">
                                ...
                                <div className="inline-flex items-center gap-2 bg-orange-500/10 border border-orange-500/20 text-[#F26522] px-4 py-1.5 rounded-full text-sm font-semibold mb-6">
                                    ...
                                    Reservas integradas de hotéis, carros e serviços exclusivos.
                                </div>
                                ...
                                <div className="flex flex-col sm:flex-row items-center gap-4">
                                    <a
                                        href="#servicos"
                                        className="w-full sm:w-auto bg-[#F26522] hover:bg-[#d95a1e] shadow-lg shadow-orange-500/20 hover:shadow-orange-500/30 transition-all text-white font-medium rounded-xl px-8 py-3.5 flex items-center justify-center gap-2 group"
                                    >
                                    ...
                                    <Link
                                        href={route('register')}
                                        className="w-full sm:w-auto bg-white border border-orange-200 text-orange-600 hover:bg-orange-50/50 transition font-medium rounded-xl px-8 py-3.5 flex items-center justify-center"
                                    >
                                        Começar Agora
                                    </Link>
                                </div>
                        ...
                        <div className="w-full px-6 md:px-12 pb-12 flex justify-center z-20">
                            <div className="w-full max-w-5xl bg-white/40 backdrop-blur-xl border border-white/60 shadow-xl rounded-2xl p-6 flex flex-col md:flex-row items-center justify-between gap-6">
                                ...
                                <div className="flex items-center gap-4 w-full md:w-1/3">
                                    <div className="p-3 bg-white/80 rounded-xl shadow-sm">
                                        <HiOutlineCurrencyDollar className="w-6 h-6 text-[#F26522]" />
                                    </div>
                                    <div>
                                ...
                                <div className="flex items-center gap-4 w-full md:w-1/3">
                                    <div className="p-3 bg-white/80 rounded-xl shadow-sm">
                                        <HiOutlineViewGrid className="w-6 h-6 text-[#F26522]" />
                                    </div>
                                    <div>
                    ...
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div id="hospedagens" className="group bg-[#FFF9F5] border border-orange-100 p-8 rounded-2xl hover:bg-white hover:shadow-xl hover:shadow-orange-500/5 hover:border-orange-300 transition-all duration-300 flex flex-col justify-between">
                                <div>
                                    <div className="w-12 h-12 rounded-xl bg-orange-500 text-white flex items-center justify-center text-2xl mb-6 group-hover:scale-110 transition">
                                        🏨
                                    </div>
