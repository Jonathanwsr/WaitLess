        ...
        Extrato Financeiro
                    ...
                    {!isGestor && !isFuncionario && (
                        <>
                          ...
                          <Link 
    href={route().has('cliente.favoritos') ? route('cliente.favoritos') : '#'} 
    title="Meus Favoritos" 
    className={`${baseLinkClass} ${route().has('cliente.favoritos') && route().current('cliente.favoritos') ? activeLinkClass : inactiveLinkClass}`}
>
    <svg className="w-6 h-6 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
